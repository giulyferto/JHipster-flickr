...
describe('Photo e2e test', () => {
  ...
  describe('new Photo page', () => {
    ...
    it('should create an instance of Photo', () => {
      ...
      cy.get(`[data-cy="taken"]`).type('2022-04-25T00:52').should('have.value', '2022-04-25T00:52');

      cy.get(`[data-cy="uploaded"]`).type('2022-04-24T23:28').should('have.value', '2022-04-24T23:28');
