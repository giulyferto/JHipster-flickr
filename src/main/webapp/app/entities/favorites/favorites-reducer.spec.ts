...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './favorites.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FAVORITES_LIST actions', async () => {
    ...
    it('dispatches FETCH_FAVORITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FAVORITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FAVORITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FAVORITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FAVORITES actions', async () => {
      const expectedActions = [
        {
