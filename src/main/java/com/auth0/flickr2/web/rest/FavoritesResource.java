...
/**
 * REST controller for managing {@link com.auth0.flickr2.domain.Favorites}.
 */
@RestController
@RequestMapping("/api")
public class FavoritesResource {
    ...
    public FavoritesResource(FavoritesService favoritesService, FavoritesRepository favoritesRepository) {
    ...
    public ResponseEntity<Favorites> createFavorites(@RequestBody Favorites favorites) throws URISyntaxException {
        ...
        Favorites result = favoritesService.save(favorites);
    ...
    public ResponseEntity<Favorites> updateFavorites(
        ...
        Favorites result = favoritesService.update(favorites);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<Favorites> partialUpdateFavorites(
        ...
        Optional<Favorites> result = favoritesService.partialUpdate(favorites);
    ...
    public ResponseEntity<List<Favorites>> getAllFavorites(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Favorites");
        Page<Favorites> page = favoritesService.findAll(pageable);
    ...
    public ResponseEntity<Favorites> getFavorites(@PathVariable Long id) {
        ...
        Optional<Favorites> favorites = favoritesService.findOne(id);
